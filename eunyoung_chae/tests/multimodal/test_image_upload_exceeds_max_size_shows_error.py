...
def test_image_upload_exceeds_max_size_shows_error_50mb():
    ...
    relative_path = '../../src/resources/asserts/files/test_doc_50mb.pdf'
...
def test_image_upload_exceeds_max_size_shows_error_51mb():
...
def test_image_upload_exceeds_max_size_shows_error_60mb():
    ...
    relative_path = '../../src/resources/asserts/files/test_doc_60mb.pdf'
    file_path = get_file_path(relative_path)
    file_name = os.path.basename(file_path) 
